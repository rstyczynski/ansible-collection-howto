...
You can view the generated HTML report for the latest test run here: link:https://rstyczynski.github.io/ansible-collection-howto/verify_report.html[JUnit HTML Report]
