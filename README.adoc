...
2. Installing collections, https://docs.ansible.com/ansible/latest/collections_guide/collections_installing.html

3. Multiple collection in one git: https://docs.ansible.com/ansible/latest/collections_guide/collections_installing.html#specifying-the-collection-location-within-the-git-repository

4. Oracle OCI Collection install, https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/5.4.0/installation/index.html
